...
-Tracks your active design time automatically (not just when Figma is open but when you're actually working)
-Knows which project you're in and logs it accordingly
-Sends a heartbeat every 30 seconds so the data stays accurate
-Handles going offline nicely and syncs back when you reconnect
...
-Click "Start Tracking" and you're done
...
When it picks up activity, it sends a heartbeat. Go idle and it just... doesn't. That's it.
